...
namespace Clases
{
    ...
    public class Carniceria
    {
        ...
        public Carniceria(int idCarne, string corte, int precio, int cantidad, Tipo tipo) :this()
        {
        ...
        /// <summary>
        /// Propiedad IdCarne con getter y setter que permite devolver o asignarle un valor 
        /// </summary>
        public int IdCarne
        {
            get { return idCarne; }
